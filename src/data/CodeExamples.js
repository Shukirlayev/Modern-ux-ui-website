  ...
  return (
    <section className="hero">
      <h1 className="text-4xl font-bold">
        {isTyping ? "AI yordamida rivojlantirish" : "Yuklanmoqda..."}
      </h1>
...
export const floatingCards = {
  "App.jsx": {
    ...
    icon: "AI",
    title: "Aqlli to‘ldirish",
    content: "AI yordamida real vaqtda kod tavsiyalari",
  },
  "Hero.jsx": {
    ...
    icon: "⚡",
    title: "Avtomatik animatsiya",
    content: "Dinamik yozish effektlari avtomatik yaratiladi",
  },
  "Navbar.jsx": {
    ...
    icon: "🔍",
    title: "Aqlli qidiruv",
    content: "Loyihangiz bo‘yicha aqlli kod qidiruv",
  },
};
