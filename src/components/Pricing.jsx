...
const plans = [
  {
    name: 'Starter',
    price: '29.99',
    description: 'Individual va kichik jamoalar uchun ideal',
    features: [
      "5 tagacha jamoa a'zolari",
      '10GB saqlash xotirasi',
      'Asosiy analitika',
  ...
  },
  {
    name: 'Professional',
    price: '79.99',
    description: 'O‘sib borayotgan bizneslar uchun eng yaxshisi',
    features: [
      "25 tagacha jamoa a'zolari",
      '100GB saqlash xotirasi',
      'Rivojlangan analitika',
      'Prioritetli qo‘llab-quvvatlash',
      'API orqali kirish',
      'Mobil ilova',
      'Maxsus integratsiyalar',
      'Rivojlangan xavfsizlik',
    ],
    mostPopular: true,
  },
  {
    ...
    features: [
      ...
      'Cheksiz saqlash xotirasi',
      'Enterprise analitika',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-gray-400 text-base text-xl sm:text-lg max-w-2xl mx-auto">
            O‘zingizga mos reja tanlang. Barcha rejalarga 14 kunlik bepul sinov
            davri kiradi.
          </p>
        </div>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <p className="text-gray-400 text-base text-xl">
            ...
            <a href="#" className="text-blue-400 hover:text-blue-300">
              Savdo bo‘limimiz bilan bog‘laning
            </a>
          </p>
        </div>
      </div>
